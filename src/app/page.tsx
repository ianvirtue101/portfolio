      ...
      <main>
          ...
          <div className="body-section__group">
            <div className="body-section__text-block">
              ...
              <p className="body-section__text">
                ...
                well equipped to deliver exceptional results for clients no
                matter the problem.
              </p>
            </div>
        ...
        <section id="resume" className="resume-section">
          ...
          <p className="resume-section__text">
            ...
            creation, and teamwork. With a strong foundation in JavaScript,
            React, Node.js, and Express, I&apos;ve successfully led
            cross-functional teams and delivered exceptional results in various
            projects.
          </p>
          <p className="resume-section__text">
            At Learnedly, I spearheaded the end-to-end design, development, and
            maintenance of the website, achieving a near-perfect Lighthouse
            score and significantly improving load times across all devices.
            I&apos;ve developed key features, such as dynamic homepages, custom
            user authentication, and interactive carousels, all while ensuring
          ...
          <p className="resume-section__text">
            ...
            Suite, Figma, and Jira. As a Content Development Manager and the
            owner of Ian Virtue Photography, I&apos;ve effectively increased
            social media engagement, managed marketing campaigns, and delivered
          ...
          <p className="resume-section__text">
            ...
            applications, working with APIs, user authentication, and
            implementing web design principles. My technical skill set includes
            proficiency in JavaScript, React, Node.js, Express, and Next.js.
          </p>
          <p className="resume-section__text">
            As a creative professional, I&apos;m well-versed in Adobe Creative
            Suite, photography, videography, and social media marketing.
            I&apos;ve successfully used Figma, Jira, Heroku, GitHub, Jest, and
            CSS/SCSS/HTML to manage projects and deliver outstanding results.
          </p>
          <p className="resume-section__text">
          ...
          <div className="resume-section__container">
            <div className="resume-section__block">
              ...
              <p className="resume-section__text">
                ...
                HTML, CSS, and RESTful APIs to create a responsive,
                user-friendly, and optimized website for search engines.
              </p>
              <p className="resume-section__text">
                Expertly developed and maintained software solutions using
                Python, demonstrating proficiency in scripting and programming.
              </p>
              <p className="resume-section__text">
            ...
            <div className="resume-section__block">
              ...
              <p className="resume-section__text">
                ...
                social media channels, including video and infographics,
                resulting in a 200% engagement increase over a 3-month period.
                Adept at implementing regular revisions and optimizations to
                ensure best results in an Agile project management environment.
              </p>
              <p className="resume-section__text">
                ...
                and on schedule. Resulting designs have been featured in
                catalogs and storefronts across Ontario.
              </p>
              <p className="resume-section__text">
